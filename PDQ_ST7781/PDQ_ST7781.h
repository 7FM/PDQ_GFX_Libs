...
#else
#define _TEMPLATE_DEF template <uint8_t LCD_D0, uint8_t LCD_D1, uint8_t LCD_D2, uint8_t LCD_D3, uint8_t LCD_D4, uint8_t LCD_D5, uint8_t LCD_D6, uint8_t LCD_D7, uint8_t LCD_CS, uint8_t LCD_RS, uint8_t LCD_WR, uint8_t LCD_RD>
...
_TEMPLATE_DEF
void _TEMPLATE_CLASS::commandList(const struct reg_cmd *cmd, uint8_t numCommands) {
...
void _TEMPLATE_CLASS::setRotation(uint8_t m) {
...
#endif
    {
        ...
        case 0:
            id_am = 0x30;
            _PARENT::_width = ST7781_TFTWIDTH;
            _PARENT::_height = ST7781_TFTHEIGHT;
            break;
        case 1:
            id_am = 0x28;
            _PARENT::_width = ST7781_TFTHEIGHT;
            _PARENT::_height = ST7781_TFTWIDTH;
            break;
        case 2:
            id_am = 0x00;
            _PARENT::_width = ST7781_TFTWIDTH;
